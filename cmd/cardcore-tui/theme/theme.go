...
// Theme holds the color palette for the TUI shell. Layout functions, the
// pre-game menu, and game render functions all accept a Theme so colors are
// runtime-constructed rather than hardcoded in package-level variables.
type Theme struct {

...
type Config struct {
	...
	// AIActionDelayMS is the pacing delay in milliseconds applied before
	// each AI turn, for UX readability. The delay elapses first and the
...
// Summary is the abbreviated form of Info returned by list operations.
type Summary struct {

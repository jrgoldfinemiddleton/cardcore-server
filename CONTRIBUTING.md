...
- **Naming.** `cardcore-server` (lowercase, hyphenated) is the Go module name. In prose, use `Cardcore` for the overall project, `Cardcore Server` for the server component, and `Cardcore TUI` for the terminal client.
